...
- 帧率：30 fps
- 风格：健身教学 + 力量感 + 科技感（参考 [script.md §7](../../remotion/rules/script.md)）
- 无文字水印 / 无品牌 logo
- 5-12s 循环 / 可拼接
```
...
**目标位置**：`remotion/public/winged_scapula_b3/videos/001_hook_compare.mov`
**shot_id**：S02（5.33s）
...
**目标位置**：`remotion/public/winged_scapula_b3/videos/002_mirror_test.mov`
**shot_id**：S03（8.82s）
...
**目标位置**：`remotion/public/winged_scapula_b3/videos/003_wall_push.mov`
**shot_id**：S04（8.53s）
...
**目标位置**：`remotion/public/winged_scapula_b3/images/transition_4actions.png`
**shot_id**：S05（4.41s）
...
**目标位置**：`remotion/public/winged_scapula_b3/audios/sfx/T1_whoosh.mp3`
**shot_id**：TR01（0.7s）
...
**目标位置**：`remotion/public/winged_scapula_b3/audios/sfx/T2_sweep.mp3`
...
**目标位置**：`remotion/public/winged_scapula_b3/audios/sfx/T3_pop.mp3`
...
cd ..
cp resources/videos/winged_scapula_b3_001_hook_compare.mov remotion/public/winged_scapula_b3/videos/
cp resources/videos/winged_scapula_b3_002_mirror_test.mov remotion/public/winged_scapula_b3/videos/
cp resources/videos/winged_scapula_b3_003_wall_push.mov remotion/public/winged_scapula_b3/videos/
cp resources/images/winged_scapula_b3_transition_4actions.png remotion/public/winged_scapula_b3/images/transition_4actions.png
cp resources/audios/sfx/winged_scapula_b3_T1_whoosh.mp3 remotion/public/winged_scapula_b3/audios/sfx/
cp resources/audios/sfx/winged_scapula_b3_T2_sweep.mp3 remotion/public/winged_scapula_b3/audios/sfx/
cp resources/audios/sfx/winged_scapula_b3_T3_pop.mp3 remotion/public/winged_scapula_b3/audios/sfx/
```

> 复制完后，所有 7 个缺失素材就位 → 跑 [checklist.md](../../remotion/rules/checklist.md) 自检 → 准备渲染。
