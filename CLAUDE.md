...
2. **⏰ 改任何时间字段必走** [timing-sync.md](rules/timing-sync.md)——B/C 类主体 50s 锚点，A 类 ≥ 90s 全文无上限，中速 3.4 字/秒
...
| 档位 | 字/秒 | B/C 主体 | B/C 全文 | A 类主体 | A 类全文 |
|---|---|---|---|---|---|
| 🐢 慢 | 2.5 | 68s | 78s | ≥ 108s | ≥ 120s |
| 🚶 中 ⭐ | 3.4 | 50s | 60s | ≥ 80s | ≥ 90s |
| 🏃 快 | 4.0 | 42s | 52s | ≥ 68s | ≥ 78s |
