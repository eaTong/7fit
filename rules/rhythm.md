...
总时长预算：2-3.5h/条（B 类 2h / A 类 2.5h / C 类 3.5h）
...
| 阶段 | A 类（人设）| B 类（知识）| C 类（解码）|
|---|---|---|---|
| 写 copy | 30 min | 30 min | 60 min |
| 素材 | 30 min（口播）| 45 min（动作）| 60 min（截图/代码/录屏/HUD）|
| 分镜 | 30 min | 30 min | 40 min |
| 实现 | 60 min | 60 min | 120 min（含 code rendering）|
