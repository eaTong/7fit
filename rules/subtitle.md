...
| 维度 | A 人设 | B 知识 | C 解码 |
|---|---|---|---|
| **人称密度** | 高（"我/你"）| 中（"你/动作"）| 中高（"我" 30-40%）|
| **highlight 频次** | 低（5-8 处/全篇）| 高（10-15 处/全篇）| 中（8-12 处/全篇）|
| **数字频次** | 低（"练了 3 年"）| 高（"3 步 + 4 动作 + 10 分钟"）| 中（"100 次训练"）|
| **警示频次** | 低 | **高**（健身赛道必加安全提示）| 低 |
| **CTA 形式** | 互动（"评论告诉我"）| 互动（"评论交作业"）| 留悬念 + 个人品牌引流 |
| **典型字数** | 180-220 字 | 200-260 字 | 200-280 字 |
| **典型条数** | 25-30 条 | 30-40 条 | 25-35 条 |
...
> 例："我是怎么用 7fit 造了一个训练记录轮子的——3 个设计思路拆给你看"
> - highlight: "7fit"、"造轮子"、"3 个设计思路"
> - 语气：第一人称分享 + 技术拆解 + 产品思考
