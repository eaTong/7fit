/**
 * A2 TransitionSeries 版本
 * 使用 TransitionSeriesEngine 实现更丰富的转场效果
 *
 * 基于 a2_one_person_50_videos 重构，核心区别：
 * - LayoutTransitionEngine → TransitionSeriesEngine
 * - 支持 LightLeak 叠加效果
 * - 未来可升级为完整 TransitionSeries 转场
 *
...
import { TransitionSeriesEngine } from "../../components/transitions/TransitionSeriesEngine";
...
// ============================================================
// Shot 内容渲染（根据 shotId 渲染对应组件）
// ============================================================

const renderShotContent = (shot: ShotEntry) => {
  const enterFrame = shot.startFrame;
...
// ============================================================
// A2 TransitionSeries Scene 入口
// ============================================================

export const A2TransitionSeries: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: "#0A0A0A" }}>
      ...
      <BgmAudio
        bgmSrc="a2_transition_series/audios/bgm/a2_one_person_50_videos_v2.mp3"
      ...
      {/* Layer 2: TransitionSeries 引擎 */}
      <TransitionSeriesEngine
        videoSrc="videos/a2_talking_head.mov"
        shotSequence={shotSequence}
        backgroundSrc="images/bg/a2_workout_intro/s1_hook.jpg"
        backgroundType="image"
        enableLightLeak={false}
        lightLeakSeed={3}
        lightLeakHueShift={30}
        lightLeakShotIndex={4} // 第 5 镜（s5）叠加 LightLeak
      >
        {(shot) => renderShotContent(shot)}
      </TransitionSeriesEngine>
